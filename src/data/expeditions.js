  ...
  meadow: { key:"meadow", title:"초원을 달리자!", emoji:"🌾",
    ...
    scene:{ sky:["#BDE3F7","#EAF6E0"], ground:["#A5D06A","#8CBE52"], groundH:38,
      ...
      /* [사용자 확정 2026-08-01] 탁 트인 풀밭을 달린다.
         가운데 두 점은 배경 언덕 실측선에 맞춘 값 — 곧게 이으면 골짜기 위로 떠 보였다.
         (실측 잔디 윗선 x50 ≈ 13 · 오른쪽 언덕 가장자리 x70 ≈ 27) */
      path:[[10,24],[20,21],[50,15],[70,25],[90,40]],
      xi:10, iB:24,
      xa:90, aB:40, gx:88, goalB:24,
      /* 하늘길(열기구) — 13·55에서 떠서 90·70까지 곧게, 도착하면 90·40으로 내려앉아 만세.
         하늘길 높이는 캐릭터 가운데 기준 */
      fly:{ path:[[13,55],[90,70]] },
