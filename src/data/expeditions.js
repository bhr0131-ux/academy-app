...
const _RIDE_AR = {
  ...
  dragon:1.05,         unicorn:0.99,        carpet:1.21,         sled:1.01,
...
export const EXPEDITIONS = {
  ...
  forest: { key:"forest", title:"숲을 통과하자!", emoji:"🌳",
    ...
    scene:{ sky:["#D8EFC9","#F0F6E2"], ground:["#9CBF7C","#7BA45E"], groundH:36,
      ...
      /* 하늘길(드래곤·부엉이) [사용자 확정 2026-08-22] — 나무 사이 10·65에서 떠서
         숲 지붕 높이를 그대로 유지하며 90·70까지 간다. 도착하면 만세 자리(88·32)로
         내려앉는다. 하늘길 높이는 캐릭터 가운데 기준 */
      fly:{ x0:10, charB:65, x1:90, charB1:70 },
  ...
  cave: { key:"cave", title:"동굴을 빠져나가자!", emoji:"🕳️",
    ...
    scene:{ sky:["#4D4661","#6B617E"], ground:["#5D5470","#443C55"], groundH:34,
      ...
      /* 하늘길(박쥐·드래곤) [사용자 확정 2026-08-22] — 왼쪽 동굴 입구(10·60)에서
         천장 아래를 지나 오른쪽 출구(86·65)로. 도착하면 만세 자리(82·36)로 내려앉는다 */
      fly:{ x0:10, charB:60, x1:86, charB1:65 },
  ...
  desert: { key:"desert", title:"사막을 건너자!", emoji:"🏜️",
    ...
    scene:{ sky:["#FBE3B7","#FDF2DC"], ground:["#EBCB8B","#D9B26C"], groundH:36,
      ...
      /* 하늘길(양탄자·독수리·열기구) [사용자 확정 2026-08-22] — 10·65에서 떠서
         모래언덕 위로 86·75까지. 도착하면 만세 자리(78·34)로 내려앉는다 */
      fly:{ x0:10, charB:65, x1:86, charB1:75 },
  ...
  sea: { key:"sea", title:"보물섬에 도착하자!", emoji:"🏝️",
    ...
    scene:{ sky:["#BEE4F5","#E9F6F0"], ground:["#6FBDDD","#4E9FC6"], groundH:40,
      ...
      /* 물속길(잠수정) [사용자 확정 2026-08-22] — 수면 아래 10·20에서 출발해
         80·25까지 잠항하고, 도착하면 떠올라 만세 자리(74·50)로. 높이는 가운데 기준 */
      dive:{ x0:10, charB:20, x1:80, charB1:25 },
      /* 하늘길 [사용자 확정 2026-08-22] — 지금 바다 탈것에는 나는 것이 없다.
         나중에 나는 탈것을 넣으면 이 길로 간다 (10·70 -> 80·82) */
      fly:{ x0:10, charB:70, x1:80, charB1:82 },
  ...
  treasure: { key:"treasure", title:"보물상자를 찾자!", emoji:"🎁",
    ...
    scene:{ sky:["#7EC8F0","#D9EFB0"], ground:["#EBD188","#D6B863"], groundH:34,
      ...
      /* 하늘길(드래곤·부엉이·양탄자) [사용자 확정 2026-08-22] — 10·65에서 떠서
         폭포 절벽 위 90·70까지. 도착하면 만세 자리(78·30)로 내려앉는다 */
      fly:{ x0:10, charB:65, x1:90, charB1:70 },
  ...
  snow: { key:"snow", title:"설원을 건너자!", emoji:"❄️",
    ...
    scene:{ sky:["#BBD9F7","#E8F3FC"], ground:["#EAF2FA","#CFE2F2"], groundH:34,
      ...
      /* 하늘길(드래곤) [사용자 확정 2026-08-22] — 설산 위 10·65에서 떠서
         오로라 아래 90·70까지. 도착하면 만세 자리(80·40)로 내려앉는다 */
      fly:{ x0:10, charB:65, x1:90, charB1:70 },
