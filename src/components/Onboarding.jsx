...
import { DAYS } from "../data/tokens.js";
...
/* [삭제 2026-08-16] GuideModal 을 파일에서 뺐다 (사용자 확정).
   'reward'(보상 탭 안내)와 'welcome'(엄마 권한 안내)을 차례로 없앤 뒤로 부르는 곳이
   한 군데도 없었고, 기본 'guide' 갈래는 원래부터 쓰이지 않았다.
   되돌릴 일은 git 히스토리에서 꺼낸다(CLAUDE.md 규칙 6과 같은 방침). */
