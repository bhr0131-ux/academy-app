...
const MAP_LONG = {
  ...
  // 학원 건물 고정 배치 (사용자 배치도 확정): ①~④ 기본 자리, 학원이 늘면 ⑤→⑥→⑦→⑧ 순으로 추가.
  // 배정은 항상 시간순 = 지도 위→아래 (렌더 시 y 정렬). 긴 지도는 학원 4곳 이상일 때 사용.
  spots: {
    4: [[35,30],[67,38.5,"bottom"],[66.5,51.5],[24,71]],
    5: [[35,30],[67,38.5,"bottom"],[66.5,51.5],[24,71],[77.5,29.5]],
    6: [[35,30],[67,38.5,"bottom"],[66.5,51.5],[24,71],[77.5,29.5],[37,60]],
    7: [[35,30],[67,38.5,"bottom"],[66.5,51.5],[24,71],[77.5,29.5],[37,60],[44,26]],
    8: [[35,30],[67,38.5,"bottom"],[66.5,51.5],[24,71],[77.5,29.5],[37,60],[44,26],[47.5,49.5]],
  },
