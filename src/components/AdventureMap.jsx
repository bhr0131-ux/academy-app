...
const MAP_SHORT = {
  ...
  yr: 1704 / 923,
  bw: 16.8, fs: 15.2, // 짧은 지도 건물 크기 (사용자 조정 2026-08-12: 여기서 20% 더 축소 21→16.8)
  ...
  /* [사용자 확정 2026-08-12] 자리 좌표는 사용자가 지도 위에 찍어 준 점 그대로.
       ① 좌상 38·39.8 → ② 우측 79.9·54.8 → ③ 좌하 26.9·76
  ...
  spots: {
    1: [[38,39.8,null,3]],                             // ①만
    2: [[38,39.8,null,3],[79.9,54.8]],                 // ① 고정 + ② 추가
    3: [[38,39.8,null,3],[79.9,54.8],[26.9,76,"bottom"]], // ①② 고정 + ③ 추가(라벨 집 아래)
  },
