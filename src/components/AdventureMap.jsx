...
const MAP_LONG = {
  ...
  ar: "885 / 1777",
  chest: [46, 89],
  chestOpen: [44, 92, 13],   // 도착 시 덮어 그릴 '열린 상자' [중심x%, 바닥y%, 폭%] — v10 원화의 상자 크기에 맞춰 재측정
  chestHide: [46, 87.8, 20, 10.5], // 배경에 그려진 '닫힌 상자'를 지울 모래 패치 [중심x%, 중심y%, 폭%, 높이%]
  cdy: 5.5,         // 진행도 칩(🔒 n/N)을 상자 아래로 내리는 오프셋 (지도 높이 % — 상자 안 가리게)
  // 원화에 그려진 동물들의 머리 위 좌표 (%) — 랜덤 이벤트 날 👋 말풍선 자리 (그리드 실측)
  animals: { ev_parrot: [81, 15.5], ev_monkey: [80, 39.5], ev_toucan: [16, 68.5], ev_boar: [76, 71], ev_frog: [14, 81] },
  ...
  spots: {
    ...
    4: [[79.5,29,null,1],[43.7,47.8,null,3],[73.5,56.4,null,2],[22,73.2,null,0]],
    5: [[44,30.9,null,0],[79.5,29,null,1],[43.7,47.8,null,3],[73.5,56.4,null,2],[22,73.2,null,0]],
    6: [[44,30.9,null,0],[79.5,29,null,1],[43.7,47.8,null,3],[37,59.8,null,1],[73.5,56.4,null,2],[22,73.2,null,0]],
    7: [[44,30.9,null,0],[79.5,29,null,1],[31,38.6,null,2],[43.7,47.8,null,3],[37,59.8,null,1],[73.5,56.4,null,2],[22,73.2,null,0]],
    8: [[44,30.9,null,0],[79.5,29,null,1],[27,31.9,null,3],[31,38.6,null,2],[43.7,47.8,null,3],[37,59.8,null,1],[73.5,56.4,null,2],[22,73.2,null,0]],
  },
  // v10 원화 모래길 중심선 — 진행 방향의 직각으로 재며 걷는 방식으로 자동 추출.
  //   다리(나무)는 색이 끊겨 자동 추적이 강 옆으로 새므로, 다리 구간만 손으로 이었다.
  pointAt: mkPointAt([
    [52,20.5],[52.1,21.5],[53.4,22.5],[51.7,23.8],[50.4,24.7],[50.4,25.8],[51.4,26.9],[52.6,27.8],
    [54.7,28.5],[56.9,29],[58.8,29.5],[60.7,29.8],[62.4,30.3],[64.1,30.9],[65.4,31.7],[64.6,33.7],
    [62.2,35.3],[60.9,36.3],[58.4,36.9],[56.2,37.3],[54,37.6],[52,37.8],[50.1,38.1],[48.2,38.4],
    [46.3,38.7],[44.5,39.2],[42.6,39.6],[41.1,40.4],[39.9,41.2],[40.7,43.2],[43.3,44.8],[42.2,45.8],
    [45.4,47.1],[48.8,47.6],[51.2,47.8],[53.1,48.2],[55,48.5],[56.8,49],[58.5,49.6],[59.8,50.4],
    [60.6,51.5],[60.9,52.6],[60.5,53.8],[59.8,54.9],[58.5,55.9],[56.6,56.6],[55,57.3],[53.5,58],
    [52.6,58.9],[51.8,59.9],[52,61.1],[51.8,62.1],[54.9,63.4],[55.7,64.3],[56.5,65.5],[53,66.9],
    [49.3,68.2],[45.6,69.6],[42,71],[37,72],[39.2,73.7],[38.7,74.7],[38.1,75.7],[38.3,76.7],
    [38.8,77.8],[39.9,78.7],[41.3,79.6],[43,80.3],[44.6,80.9],[46.5,81.4],[47.9,82.2],[49.6,82.7],
    [51.9,82.8],[53.3,83.7],[54.5,84.6],[55.5,85.6],[55.9,86.6],[57.7,87.3],[56.5,90.3],
  ], 1777 / 885),
};
...
const MAP_SHORT = {
  ...
  ar: "834 / 1536",
  chest: [45, 85],
  chestOpen: [43, 90, 13], // 도착 시 덮어 그릴 '열린 상자' [중심x%, 바닥y%, 폭%] — v10 원화의 상자 크기에 맞춰 재측정
  chestHide: [45, 85.3, 21, 11.5], // 배경에 그려진 '닫힌 상자'를 지울 모래 패치 [중심x%, 중심y%, 폭%, 높이%]
  cdy: 6.5,         // 진행도 칩(🔒 n/N)을 상자 아래로 내리는 오프셋 (지도 높이 % — 상자 안 가리게)
  // 원화에 그려진 동물들의 머리 위 좌표 (%) — 랜덤 이벤트 날 👋 말풍선 자리 (그리드 실측)
  animals: { ev_parrot: [82, 19], ev_monkey: [81, 41.5], ev_toucan: [16, 66.5], ev_boar: [78, 69], ev_frog: [15, 76.5] },
  ...
  spots: {
    1: [[80,50.6]],                                  // 우측 — 원숭이를 덮는 위치
    2: [[37.7,36,null,3],[80,50.6]],                 // 좌상(라벨 집 위) → 우측
    3: [[37.7,36,null,3],[80,50.6],[21.5,79,"bottom"]], // 좌상 → 우측 → 좌하(라벨 집 아래)
  },
  // v10 원화 모래길 중심선 — 긴 지도와 같은 방식으로 추출, 다리 구간만 수동 보간
  pointAt: mkPointAt([
    [54.5,22],[56.2,23.2],[55.1,24.6],[53.9,25.7],[55.2,27.1],[56.7,28.1],[59,28.9],[61.3,29.4],
    [63.3,29.9],[65.2,30.5],[67,31.1],[68,32.4],[66.9,34.5],[64.2,36.1],[61,37],[58.7,37.6],
    [56.3,37.8],[54.1,38.1],[52,38.4],[50,38.6],[48,39],[46,39.5],[44.2,40.1],[42.5,40.9],
    [42.5,43.1],[44.4,45.1],[47.2,46.4],[48.9,47.3],[51.6,47.7],[53.8,48.1],[56,48.4],[58,48.8],
    [60,49.1],[62,49.6],[63.8,50.2],[65.1,51.3],[64.5,53.5],[62.2,55.3],[60.6,56.4],[58.2,57.2],
    [56.2,57.8],[54.7,58.7],[55.1,60.6],[55.5,61.9],[55.2,65.4],[51.7,66.9],[48.2,68.4],[44.7,69.9],
    [41.7,71.2],[36.5,72],[38.7,73.7],[38.3,74.9],[39,76.1],[40.3,77.1],[42.3,78],[44,78.8],
    [45.1,79.7],[48,80],[50.7,79.8],[52.3,81.1],[54.2,81.6],[54.9,83.2],[56.3,84],[55.1,86.1],
    [59,86.8],[58.9,88.3],
  ], 1536 / 834),
};
