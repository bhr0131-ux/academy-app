...
const MAP_LONG = {
  ...
  /* 동물 여섯 [중심x%, 바닥y%, 폭%] — 하루 세 마리, 그룹마다 하나씩 (shownAnimals)
     ...
     폭은 20 으로 통일하고 개구리만 28.6 — 원화가 납작해(가로세로 1.59:1)
     같은 폭에서 유독 작아 보인다.
     높이는 원화 비율을 따라가므로 폭이 같아도 종마다 다르다 — 높이% = 폭% / (원화비율 × yr). */
  animals: { ev_parrot: [88, 29.8, 20], ev_monkey: [87.4, 45.9, 20], ev_toucan: [15.3, 34.9, 20],
             ev_boar: [85, 73, 20], ev_frog: [20.6, 61.4, 28.6],
             ev_turtle: [70.3, 89.6, 20] },
  ...
  pointAt: mkPointAt([
    ...
    [46.4,83.1],[47.6,84],[48.5,85.1],[49.3,85.9],[49.6,86.7],[50.3,87.4],[51.5,88],[53.2,88.5],
    [55.1,88.9],[56.9,89.3],[58.4,89.7],[59.6,90.1],[60.3,90.6],
  ], 1777 / 885),
};
...
const MAP_SHORT = {
  ...
  pointAt: mkPointAt([
    ...
    [46.2,86],[45.8,87],[45.6,88],[45.9,88.8],[46.8,89.4],[48.2,89.8],[49.8,90.1],[51,90.4],
