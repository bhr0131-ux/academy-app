...
const MAP_LONG = {
  ...
  spots: {
    ...
    /* [사용자 확정 2026-08-12] 4곳은 사용자가 지도에 찍어 준 점 그대로 (위→아래 = ①②③④).
       건물 번호(1·3·2·0)는 예전 4곳 배치 그대로 — 이웃끼리 같은 그림이 안 오게 고른 값이다.
       ※ 5~8곳은 아직 예전 자리다. 사용자가 ⑤부터 좌표를 마저 주면 그때 '앞 n개' 규칙으로 맞춘다
         (그때까지는 4곳→5곳으로 늘 때 자리가 한 번 섞인다). */
