...
const MAP_LONG = {
  ...
  // ※ 사용자 번호 규칙: 학원 번호는 '길 순서' 기준 (지도 위에서 길을 따라 몇 번째로 만나는가).
  //    배열 순서는 시간순이라 둘이 항상 같지는 않다 — 예: 4곳 배치는 ②자리(길 1번째)가 첫 수업.
  spots: {
    4: [[43.7,50.6],[75.5,28],[73.5,56.5],[23,74]],   // 수학=폭포 옆 자리(사용자 지정 위치) / 피아노=돌아치
    5: [[77.5,29.5],[75.5,28],[43.7,50.6],[73.5,56.5],[23,74]],
    6: [[77.5,29.5],[75.5,28],[31,38],[73.5,56.5],[37,60],[23,74]],
    7: [[44,26],[77.5,29.5],[75.5,28],[31,38],[73.5,56.5],[37,60],[23,74]],
    // 6곳 이상은 중앙 왼쪽이 [37,60]과 겹쳐 폭포 옆 자리를 못 쓴다 → 나무집 자리[31,38] 유지.
    // 8곳은 원래 그 부근에 자리가 있었으므로([47.5,49.5]) 사용자 지정 좌표로 맞춰 둔다.
    8: [[44,26],[77.5,29.5],[75.5,28],[31,38],[43.7,50.6],[73.5,56.5],[37,60],[23,74]],
  },
