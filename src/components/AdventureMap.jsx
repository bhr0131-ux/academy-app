...
const MAP_LONG = {
  ...
  ar: "853 / 1844",
  chest: [52, 88],
  cdy: 6,           // 진행도 칩(🔒 n/N)을 상자 아래로 내리는 오프셋 (지도 높이 % — 상자 안 가리게)
  yr: 1844 / 853,
  bw: 26, fs: 24,   // 건물 표시 폭(%)·이모지 크기 (사용자 조정: 소폭 축소)
  fpk: 64,          // 발자국 개수 (경로 등간격)
  // 학원 건물 고정 배치 좌표 (길 '옆' 잔디, 좌우 번갈아)
  spots: {
    3: [[78,30],[71,45],[33,76]],
    4: [[78,30],[71,45],[20,63],[33,76]],
  },
  // v8 수채화 원화 모래길 중심선 자동 추출(색 분류 스캔) 좌표 — 다리 구간은 목재라 수동 보간
  pointAt: mkPointAt([
    [50.5,19.5],[52,20.9],[54,21.8],[53,22.8],[50.5,23.6],[50.5,24.4],[52.5,25.2],[55.5,26],
    [58.5,26.7],[61.5,27.4],[64,28.2],[65.5,29.2],[65.5,30.2],[63,31],[59,31.8],[55,32.5],
    [51.5,33.2],[49.5,34],[47.5,34.9],[45.5,35.8],[44.5,36.5],[41.5,37.2],[38.5,38],[37.8,38.9],
    [39.5,39.8],[41.5,40.5],[44,41.2],[46.5,41.8],[49,42.4],[52,43.1],[54.5,43.7],[56.5,44.4],
    [59,45],[61.5,45.6],[63.2,46.3],[62.5,47.1],[60.5,47.9],[58.5,48.6],[56.5,49.3],[54.5,50],
    [52.5,50.7],[51,51.5],[49.5,52.3],[49.5,53.2],[50,54.1],[50.5,55],[51.5,55.9],[53.5,56.6],
    [56,57.3],[58.5,58],[60.5,58.8],[62,59.6],[63,60.5],[62.5,61.5],[61,62.3],[58,63.2],
    [54,64.2],[50,65.2],[46,66.2],[42,67],[39,67.8],[37.5,68.8],[36.7,69.8],[36.5,70.8],
    [37,71.8],[38.5,72.8],[40.5,73.7],[43,74.6],[45.5,75.5],[48,76.3],[50.5,77.1],[52,77.9],
    [53,78.8],[54,79.7],[54.8,80.7],[55.2,81.7],[55,82.7],[54.5,83.7],[53.5,84.6],
  ], 1844 / 853),
};
...
const MAP_SHORT = {
  ...
  ar: "952 / 1652",
  chest: [50, 85],
  cdy: 7.5,         // 진행도 칩(🔒 n/N)을 상자 아래로 내리는 오프셋 (지도 높이 % — 상자 안 가리게)
  yr: 1652 / 952,
  ...
  // v7 크리스프 원화 모래길 중심선 자동 추출(색 분류 스캔) 좌표 — 다리 구간은 목재라 수동 보간
  // 우측 굽이 정점은 실측 중심(66.5)보다 살짝 좌측 — 캐릭터가 길 한가운데를 걷는 느낌 (사용자 조정)
  pointAt: mkPointAt([
    [50,21],[50.8,23],[51.3,25],[52.5,26.8],[55,28.2],[58.5,29.2],[62,30.2],[65,31.2],
    [67.5,32.3],[68,33.6],[67.6,34.8],[65.5,36.2],[62,37.2],[57,38],[50,38.8],[45,39.6],
    [42.7,40.8],[41.8,42.2],[42.5,43.6],[44.5,44.5],[47.5,45.3],[51.5,46],[55.5,46.8],[59,47.6],
    [62,48.6],[64.5,49.6],[66,50.7],[66,52],[64.5,53],[62,54],[60,55],[57.5,56],
    [55,57.2],[53.5,58.4],[52.8,59.6],[51.5,61],[49.5,62.5],[47.5,64],[45.5,65.5],[43.5,67],
    [42,68.5],[40.5,70],[38.5,71.5],[37.3,73],[37.2,74.5],[38,76],[40.5,77.4],[43.5,78.7],
    [46,80],[48,81.3],
  ], 1652 / 952),
};
