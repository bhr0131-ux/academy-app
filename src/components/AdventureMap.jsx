...
const MAP_LONG = {
  ...
  /* 동물 일곱 [중심x%, 바닥y%, 폭%] — 하루 두 마리만 나온다 (rollMapAnimals)
     [사용자 확정 2026-08-13] 폭은 일곱 종 모두 20 으로 통일한다(예전엔 9~24로 제각각).
  ...
  animals: { ev_parrot: [82, 30, 20], ev_monkey: [70, 54, 20], ev_toucan: [15, 74, 20],
             ev_boar: [85, 73, 20], ev_frog: [15, 86, 20],
             /* 나비·거북이는 예전 '손님' 자리(중심 기준)를 바닥 기준으로 환산해 옮겼다 */
             ev_butterfly: [28, 25.3, 20], ev_turtle: [15, 91, 20] },
...
const MAP_SHORT = {
  ...
  /* 동물 일곱 [중심x%, 바닥y%, 폭%] — 하루 두 마리만 나온다 (rollMapAnimals).
     ...
     [사용자 확정 2026-08-13] 폭은 일곱 종 모두 20 으로 통일한다(예전엔 10~24로 제각각).
     높이는 원화 비율을 따라가므로 폭이 같아도 종마다 다르다 — 높이% = 폭% / (원화비율 × yr). */
  animals: { ev_parrot: [81.9, 31.2, 20], ev_monkey: [90.3, 56.8, 20], ev_toucan: [15.5, 34.4, 20],
             ev_boar: [87.8, 74.1, 20], ev_frog: [12.1, 79.2, 20],
             ev_butterfly: [31.6, 48.9, 20], ev_turtle: [68, 87.9, 20] },
