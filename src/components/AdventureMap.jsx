...
const MAP_LONG = {
  ...
  ar: "885 / 1778",
  chest: [37, 88],
  /* 상자는 길 끝(50,90) '옆'에 둔다 — 길 위에 두면 도착한 캐릭터가 상자를 밟고 선다.
     [중심x%, 바닥y%, 폭%] — v11 원화엔 상자가 안 그려져 있어 따로 얹는다. */
  chestClosed: [37, 93, 16],
  ...
  spots: {
    ...
    4: [[79.5,29,null,1],[33.5,48.5,null,3],[73.5,56.4,null,2],[20,80,null,0]],
    5: [[44,30.9,null,0],[79.5,29,null,1],[33.5,48.5,null,3],[73.5,56.4,null,2],[20,80,null,0]],
    6: [[44,30.9,null,0],[79.5,29,null,1],[33.5,48.5,null,3],[73.5,56.4,null,2],[24,69,null,1],[20,80,null,0]],
    7: [[44,30.9,null,0],[79.5,29,null,1],[31,38.6,null,2],[33.5,48.5,null,3],[73.5,56.4,null,2],[24,69,null,1],[20,80,null,0]],
    8: [[44,30.9,null,0],[79.5,29,null,1],[69,38,null,3],[31,38.6,null,2],[33.5,48.5,null,3],[73.5,56.4,null,2],[24,69,null,1],[20,80,null,0]],
  },
  pointAt: mkPointAt([
    /* v12 원화 모래길 중심선 — 진행 방향의 직각으로 재며 걷는 방식으로 다시 뽑았다.
       v11에서 길이 좁아지고 굽이가 바뀌어 옛 86점 중 23점이 길 밖으로 나갔다. */
    [58.2,22.1],[58.7,22.8],[58.4,23.3],[58.2,24.3],[57.6,25.2],[56.4,26.1],[54.9,26.8],[54.1,27.5],
    [53.3,28.2],[53.4,29.1],[53.7,30],[54.7,30.9],[55.9,31.6],[57.5,32.3],[58.8,32.8],[60.3,33.2],
    [61.6,33.7],[62.3,34.4],[62.9,35.3],[62.9,36.4],[62.2,37.3],[60.9,38.2],[59.6,38.8],[57.7,39.3],
    [56,39.5],[54.5,39.8],[53,40],[51.5,40.3],[50.1,40.7],[48.7,41.1],[47.5,41.5],[46.3,42.1],
    [45.3,42.7],[44.6,43.4],[44.1,44.1],[44.2,44.9],[44.5,45.7],[45.3,46.5],[46.4,47.1],[47.7,47.7],
    [49,48.1],[50.5,48.5],[51.9,48.8],[53.4,49.1],[54.9,49.4],[56.3,49.7],[57.7,50.1],[59,50.5],
    [60.2,51],[61.1,51.6],[61.7,52.3],[62,53.1],[61.8,53.9],[61.4,54.6],[60.6,55.3],[59.6,56],
    [58.7,56.6],[57.8,57.3],[57.2,58.1],[56.7,59],[55.9,60.2],[55,61.3],[53.2,63.8],[51,66.2],
    [48.8,68.5],[46.8,70.4],[44.8,72.4],[43.6,72.9],[42.5,73.5],[41.4,74.1],[40.4,74.7],[39.6,75.4],
    [38.9,76.1],[38.7,77],[38.8,77.9],[39.6,78.8],[40.6,79.7],[42.1,80.5],[43.2,81.4],[45,82.2],
    [46.4,83.1],[47.6,84],[48.5,85.1],[49.3,85.9],[49.5,86.8],[49.6,87.6],[49.6,88.4],[49.6,89.2],
    [49.7,90],[49.7,90.7],
  ], 1777 / 885),
};
...
const MAP_SHORT = {
  ...
  animals: { ev_parrot: [83, 32, 17], ev_monkey: [72, 56, 21], ev_toucan: [15, 73, 21],
             ...
             ev_butterfly: [28, 26.8, 10], ev_turtle: [12, 90, 13] },
  ...
  /* [사용자 확정 2026-08-12] 세 자리를 모두 옮겼다 (사용자가 지도 위에 찍어 준 점).
     ① 좌상 37.7·36 → 38·39.8   (황금 게이트를 조금 아래로)
     ② 우측 80·50.6 → 79.9·54.8 (돌 게이트를 조금 아래로)
     ③ 좌하 21.5·79 → 26.9·76   (텐트를 오른쪽 위로 — 길 쪽으로 당김)
     배열 순서 = 시간순(①②③)이라 좌표를 옮겨도 학원 배정 순서는 안 바뀐다.
     n=1·2·3 이 앞 배치의 자리를 그대로 포함하는 규칙도 유지했다. */
  spots: {
    1: [[79.9,54.8]],                                  // 우측 — 원숭이를 덮는 위치
    2: [[38,39.8,null,3],[79.9,54.8]],                 // 좌상(라벨 집 위) → 우측
    3: [[38,39.8,null,3],[79.9,54.8],[26.9,76,"bottom"]], // 좌상 → 우측 → 좌하(라벨 집 아래)
  },
  // v10 원화 모래길 중심선 — 긴 지도와 같은 방식으로 추출, 다리 구간만 수동 보간
  pointAt: mkPointAt([
    [56,23],[55.3,24.3],[55,24.8],[54.5,25.6],[54.2,26.6],[54.4,27.5],[55.1,28.3],[56.3,29.1],
    [57.8,29.7],[59.3,30.2],[60.9,30.7],[62.5,31.1],[63.9,31.6],[64.7,32.4],[65.5,33.3],[65.4,34.5],
    [64.4,35.7],[62.9,36.8],[61.3,37.7],[59.1,38.4],[57.1,38.9],[55.4,39.2],[53.8,39.5],[52.3,39.8],
    [50.7,40.2],[49.2,40.6],[47.9,41.1],[46.6,41.7],[45.7,42.5],[45,43.3],[44.9,44.3],[45.2,45.3],
    [46.1,46.2],[47.2,47],[48.7,47.7],[50.2,48.2],[51.8,48.6],[53.4,48.9],[55,49.2],[56.6,49.5],
    [58.2,49.9],[59.7,50.2],[61.1,50.7],[62.3,51.3],[63,52.2],[63.5,53.2],[63.2,54.4],[62.4,55.6],
    [61.1,56.7],[59.9,57.6],[58.3,58.4],[57.1,59.2],[56.2,59.9],[55.7,60.8],[55.6,61.7],[55.6,62.7],
    [55.9,63.7],[56.4,64.6],[56.2,65.6],[55.1,66.7],[53.4,67.8],[51,68.9],[47.9,70],[45.2,71.1],
    [43,72],[41.4,72.8],[40.2,73.6],[39.6,74.5],[39.3,75.4],[39.4,76.3],[39.8,77.2],[40.7,78],
    [41.8,78.8],[43.1,79.4],[44.4,80],[45.5,80.8],[46.4,81.6],[46.8,82.6],[46.8,83.7],[46.6,84.8],
    [46.2,86],[45.8,87],[45.5,88.1],[45.4,88.6],[45.1,90],
  ], 1536 / 834),
};
