...
const MAP_SHORT = {
  ...
  /* 동물 일곱 [중심x%, 바닥y%, 폭%] — 하루 두 마리만 나온다 (rollMapAnimals).
     ...
     단 두 종만 예외다 — 나비 14(20에서 30% 축소), 개구리 26(20에서 30% 확대).
     높이는 원화 비율을 따라가므로 폭이 같아도 종마다 다르다 — 높이% = 폭% / (원화비율 × yr). */
  animals: { ev_parrot: [81.9, 31.2, 20], ev_monkey: [86.6, 49.3, 20], ev_toucan: [10.5, 34.4, 20],
             ev_boar: [87.8, 74.1, 20], ev_frog: [10.3, 71.7, 28.6],
             ev_butterfly: [65.4, 44.8, 11.2], ev_turtle: [68, 87.9, 20] },
