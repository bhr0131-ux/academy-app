...
const MAP_SHORT = {
  ...
  /* 동물 일곱 [중심x%, 바닥y%, 폭%] — 하루 두 마리만 나온다 (rollMapAnimals).
     ...
     폭(크기)은 아직 사용자 조정 전이라 그대로 둔다. */
  animals: { ev_parrot: [81.9, 31.2, 17], ev_monkey: [90.3, 56.8, 21], ev_toucan: [15.5, 34.4, 21],
             ev_boar: [87.8, 74.1, 18], ev_frog: [12.1, 79.2, 24],
             ev_butterfly: [31.6, 48.9, 10], ev_turtle: [68, 87.9, 13] },
