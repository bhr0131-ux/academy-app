...
| bg-deepsea-v3-src.webp | 꾸미기 배경 '별빛 심해' 원화 v3 (868×1812 = 1:2.09 — 무대 칸 비율과 정확히 같아 한 픽셀도 안 잘린다). v2(887×1774)와 구도는 같고 선이 또렷해지고 고래·아치가 커진 판. 받은 그대로 톤 보정 없음. art-src 는 q92(381KB), 배포본은 q80(177KB) | stage-bg-deepsea.webp |
