...
| bg-adventure-meadow-v9-src.webp | 탐험 모드 무대 기본 배경 v9 (866×1815 = 1:2.10 — 무대 칸 비율에 맞춘 세로 긴 판. v8과 구도는 같고 채도를 더 올려 하늘·호수가 선명해진 판. 앞쪽 야자잎·나무 없이 트인 구도. 받은 그대로 톤 보정 없음, 현행) | stage-adventure-meadow.webp |
