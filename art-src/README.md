...
| safari-boy-outfit-src.webp | **사파리 옷 원화 남아 (사용자 원화 2026-08-20)** — 864×1820 캔버스에 **옷만 오려 낸 그림**(알파 상자 (177,684)-(662,1299)). 크림 셔츠 + 탄색 카고 조끼 + 카고 반바지. 배율 0.62 · 가로만 1.12배 · 깃 위끝 y380 → 탑재 상자 (344,380)-(680,761). 그림이 성별로 갈리는 첫 아이템(top_vest 의 img=남아 / imgGirl=여아) | avatar/top/safari-outfit-boy.webp |
