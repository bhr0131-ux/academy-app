...
| bg-dino-v2-src.webp | 꾸미기 배경 '공룡 섬' 원화 v2 (865×1819 = 1:2.10 — 무대 칸 1:2.09 와 거의 같다). v1과 구도는 같고 앞쪽 바위·수풀이 빠져 모랫길이 트이고, 하늘과 초원이 더 밝고 맑아진 판. 받은 그대로 톤 보정 없음. art-src 는 q92(224KB), 배포본은 q80(84KB) | stage-bg-dino.webp |
