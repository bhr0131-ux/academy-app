...
| bg-adventure-meadow-v6-src.webp | 탐험 모드 무대 기본 배경 v6 (866×1815 = 1:2.10 — 무대 칸 비율에 맞춘 세로 긴 판. 산·호수·모래길, 수채 질감을 뺀 평면 채색으로 교체. 받은 그대로 톤 보정 없음, 현행) | stage-adventure-meadow.webp |
