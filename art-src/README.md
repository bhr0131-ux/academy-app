...
| bg-deepsea-v10-src.webp | 꾸미기 배경 '깊은 바다' 원화 v10 (872×1804 = 1:2.069 — 무대 칸 1:2.09 와 거의 같아 좌우가 아주 조금 잘린다). v9와 구도·소품은 그대로다(바위 협곡 사이 넓은 모랫길 · 위쪽 고래 실루엣 · 가운데 바다거북 · 왼쪽 아래 해마 · 좌우 산호·해초 · 수면 빛줄기) — 전체가 한층 밝고 부드러워졌다. 모랫길이 거의 흰빛에 가깝게 밝아지고 물색도 옅어졌으며 바위 결이 매끈해졌다. 그 덕에 압축이 잘 먹어 배포본이 41KB — 지금까지 배경 중 가장 가볍다(v9는 75KB). deco 🫧 🐙 ✨ 🫧 🐚 · tint 0.10 · darkStage 끔 — v9 그대로다. 받은 그대로 톤 보정 없음. art-src 는 q92(107KB), 배포본은 q80(41KB) | stage-bg-deepsea.webp |
