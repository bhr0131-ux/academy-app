...
| expedition/char/{common,girl}-sit-src.webp | 앉기(탑승) 포즈 남녀 원화 (2026-08-09 받음, 493×716 / 278×459). **아직 앱에 안 쓴다** — 탈것 원화 32종에 이미 아이가 함께 그려져 있어서(RIDE_READY·RIDE_GIRL_READY 각 32) 앱은 탈 때 탈것 그림 한 장만 그린다. CHAR_IMG.ride 슬롯은 어느 챕터도 pose:"ride"를 안 써서 비어 있는 것이지, 그림이 없어서가 아니다. 쓸 일이 생기면(예: 쉬는 날 대기 포즈) halo 재색칠(남 5,194px · 여 3,233px) 후 남녀 같은 높이로 줄여 탑재할 것 | (미탑재) |
