...
2~4단계는 이름·설명만 보고 어울리는 색으로 짝지었다 — 개구쟁이(장난스러운 보라,
양팔 들고 활짝 웃음) · 청룡(이름 그대로 파랑, 팔짱 낀 늠름한 자세) · 전설(수정 장식
얹은 보라, 반짝이는 눈) — 사용자가 순서를 다르게 의도했으면 알려 주면 다시 짝짓는다.

| 원화 | 용도 | 탑재 에셋 |
|---|---|---|
| pet/egg-src.webp | 0단계 '신비한 알' (1254×1254 → bbox 크롭 1168×1223) | pet/egg.webp |
| pet/stage1-dragon-src.webp | 1단계 '아기 드래곤' (1288×1221 → bbox 크롭 1212×1196) | pet/stage1.webp |
| pet/stage2-dragon-src.webp | 2단계 '개구쟁이 드래곤' (1224×1285 → bbox 크롭 1194×1266) | pet/stage2.webp |
