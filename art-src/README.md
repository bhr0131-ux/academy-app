...
| picnic-girl-set-worn-src.webp | **딸기 소풍 세트 전신 그림 여아 (사용자 원화 2026-08-20)** — 860×1829, 알파가 머리 부분만 살아 있어서 **RGB의 검정 배경을 흘려 지워** 썼다. 여기서 신발(발목 아래)만 떼어냈다. 바구니는 손에 가려 조각나서 못 썼다 | avatar/shoes/picnic-shoes-girl.webp |
