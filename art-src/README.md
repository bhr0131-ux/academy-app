...
| bg-deepsea-v2-src.webp | 꾸미기 배경 '별빛 심해' 원화 v2 (887×1774 = 1:2.00). v1(864×1821)과 구도는 같고 아치가 커지고 모랫길이 넓어진 판. 무대 칸(1:2.09)보다 살짝 납작해 objectFit:cover 로 좌우가 각 2% 정도 잘리는데, 잘리는 자리가 물색·바위라 티가 안 난다. 받은 그대로 톤 보정 없음. art-src 는 q92, 배포본은 q80 — 300% 확대에서도 차이가 없고 프리로드 대상이라 무게를 줄였다 | stage-bg-deepsea.webp |
| bg-dino-v1-src.webp | 꾸미기 배경 '공룡 섬' 원화 v1 (864×1821 = 1:2.11 — 무대 칸 1:2.09 와 거의 같다). 초원 + 화산 + 브라키오사우루스·트리케라톱스 + 발자국 난 모랫길. 받은 그대로 톤 보정 없음. art-src 는 q92(244KB), 배포본은 q80(95KB) | stage-bg-dino.webp |
