...
| bg-space-v1-src.webp | 꾸미기 배경 '우주 탐사' 원화 v1 (886×1774 = 1:2.00). 달 지면에 선 기지(돔 + 접시안테나) · 로켓 · 발자국이 난 모랫길, 하늘엔 지구·토성·별. 그림이 장식 이모지로 넣던 것을 거의 다 이미 그려서(🚀 🪐 🌎 ⭐ 🛰️ 🌌) deco 는 그림에 없는 셋만 남겼다: ☄️ 🛸 🌠. tint 도 남색 0.32 → 0.12(원화가 이미 짙은 남보라라 같은 색을 덮으면 뭉갠다). darkStage 는 유지 — 위가 짙은 밤하늘이라 응원문구는 크림색이 맞다. 무대 칸(1:2.09)보다 납작해 objectFit:cover 로 좌우가 각 2% 정도 잘리는데, 잘리는 자리가 달 지면·하늘이라 티가 안 난다. 받은 그대로 톤 보정 없음. art-src 는 q92(276KB), 배포본은 q80(97KB) | stage-bg-space.webp |
