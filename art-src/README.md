...
| hoodie-boy-src.webp | **민트꽃 후드 원화 남아 (사용자 원화 2026-09-25)** — 852×1846 캔버스에 **옷만 오려 낸 깨끗한 그림**(연결 조각 1개, 안쪽 구멍 0). 크림 후드 + 왼팔만 보라 소매 + 민트 후드 안감·꽃 패치 + 짙은 카고 반바지. 받은 파일에 캔버스 전체로 퍼진 **알파 1~59 짜리 찌꺼기 7,610px** 이 있어 알파<20 을 0 으로 눌러 보관했다(그 전 알파 상자 (57,37)-(829,1728) → 정리 후 (109,661)-(748,1412)). **후드 안쪽 목·가슴 살은 일부러 남겼다** — 후드 구멍이 베이스 목(폭 58~62)보다 훨씬 넓어 살을 지우면 뻥 뚫린다(우주복 깃과 반대 경우). 배율 가로 0.50 · 세로 0.45 · 후드 위끝 y396 → 탑재 상자 (350,394)-(674,737) · 소매부리 y635 · 반바지 밑단 y737 | avatar/top/hoodie-boy.webp |
| acorn-boy-src.webp | **도토리 탐험복 원화 남아 (사용자 원화 2026-09-26)** — 860×1829 캔버스에 **옷만 오려 낸 깨끗한 그림**(연결 조각 1개, 안쪽 구멍 0). 크림 셔츠 + 나뭇잎 망토 + 도토리 금브로치 + 가죽 벨트 + 갈색 카고 반바지. 민트꽃 후드와 똑같이 캔버스 전체로 퍼진 **알파 1~19 짜리 찌꺼기 9,398px** 이 있어 눌러서 보관했다(정리 후 알파 상자 (79,527)-(781,1377)). **배율 0.42 균등** · 망토 위끝 y383 → 탑재 상자 (366,383)-(661,740). 배율은 **사파리 옷 남아에 맞춰** 잡았다 — 소매부리 폭 293px, 상자 x366~661 로 둘이 거의 같은 자리에 온다(사파리 (366,386)-(659,742)). 같은 몸에 입히는 같은 종류의 옷이라 자리가 어긋나면 갈아입을 때 튄다. **망토 깃 안쪽 목·가슴 살은 남겼다** — 깃 구멍(폭 39)이 베이스 목(폭 67)보다 좁아서 살을 지우면 깃 사이로 구멍이 보인다(민트꽃 후드와 같은 이유, 우주복 깃과 반대). 자홍 검사 통과(조각 1·구멍 0) | avatar/top/acorn-outfit-boy.webp |
