...
**조립 규칙** (`newbase.mjs`) — 발끝 y940 기준, 전체 키 815, 머리/키 31%로 잡으면
  머리 꼭대기 y125 · 턱 y378 · 발끝 y939 · 몸통 목 top y370(턱보다 8px 위로 겹침)
  몸통 배율 0.3735 (남녀 공통) · 머리 배율 남 0.8896 / 여 0.9427
  결과 상자 — 몸통 x381~642 y370~939 (목 폭 52) · 머리 남 x376~640 y126~382 / 여 x362~667 y126~445
머리/키는 예전 33.5% 에서 **31%로 줄였다**(사용자 요청 "머리 크기를 좀 줄여줘").
목 이음매는 턱을 목 top 보다 8px 아래로 겹쳐 투명 틈 0곳.
