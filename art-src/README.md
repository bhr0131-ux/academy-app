...
| bg-deepsea-v4-src.webp | 꾸미기 배경 '별빛 심해' 원화 v4 (887×1774 = 1:2.00). v3와 구도는 같고 앞쪽 바위·산호가 빠져 모랫길이 트인 판 — 캐릭터가 서는 아래쪽이 비었다. 무대 칸(1:2.09)보다 납작해 objectFit:cover 로 좌우가 각 2% 정도 잘리는데, 잘리는 자리가 물색·모래라 티가 안 난다. 받은 그대로 톤 보정 없음. art-src 는 q92(270KB), 배포본은 q80(118KB) | stage-bg-deepsea.webp |
