...
| bg-deepsea-v1-src.webp | 꾸미기 배경 '별빛 심해' 원화 v1 (864×1821 = 1:2.11 — 무대 칸 비율 1:2.09 와 거의 같아 잘림이 없다). 해저 신전 아치 + 수면 빛줄기 + 고래 실루엣 + 모랫길.  받은 그대로 톤 보정 없음. art-src 는 q92(426KB), 배포본은 q80(180KB) — 300% 확대에서도 차이가 없고 프리로드 대상이라 무게를 줄였다 | stage-bg-deepsea.webp |
