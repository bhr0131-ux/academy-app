...
| bg-deepsea-v5-src.webp | 꾸미기 배경 '별빛 심해' 원화 v5 (887×1774 = 1:2.00). v4에서 앞쪽 좌우에 바위·산호·크리스털·해초가 다시 들어와 가장자리가 채워진 판 — 가운데 모랫길은 그대로 트여 있다. 무대 칸(1:2.09)보다 납작해 objectFit:cover 로 좌우가 각 2% 정도 잘리는데, 잘리는 자리가 물색·모래라 티가 안 난다. 받은 그대로 톤 보정 없음. art-src 는 q92(314KB), 배포본은 q80(141KB) | stage-bg-deepsea.webp |
